...
export default function setup(config) {
    const { AUGUST_API_KEY, AUGUST_PN_SUB_KEY, AUGUST_INSTALL_ID, AUGUST_PASSWORD, AUGUST_ID, COUNTRY_CODE, } = process.env;
    ...
    if (!augustId) {
        ...
        errors.push('Invalid config.augustId or AUGUST_ID env var: must be a phone number or email address');
    }
    if (!password) {
